...
function Footer() {
    const links = [
        {
            ...
            items: [
                ...
                { name: "Best Sellers", href: "/books?filter=bestseller" },
    ...
    return (
        <>
            ...
            <footer className="bg-zinc-50 pt-15 px-4 sm:px-6 md:px-8 lg:px-20 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1)]">
                                ...
                                <div key={index}>
                                    ...
                                    <ul className="flex flex-col gap-3 list-none">
                                        {link.items.map((item, itemIndex) => (
                                            <li key={itemIndex}>
                                                <a href={item.href} className="text-sm text-zinc-600 hover:text-zinc-900 transition-colors">{item.name}</a>
                                            </li>
                                        ))}
                                    </ul>
                                </div>
